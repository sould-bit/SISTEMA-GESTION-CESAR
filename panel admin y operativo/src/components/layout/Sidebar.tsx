...
import { setSidebarOpen } from '../../stores/ui.slice';
...
export const Sidebar = () => {
    ...
    return (
        <>
            ...
            <aside className={`
                fixed inset-y-0 left-0 z-50 w-64 bg-[#0B1120] border-r border-border-dark flex flex-col shrink-0 font-sans transition-transform duration-300 ease-in-out
            ...
            `}>
                <div className="flex flex-col h-full p-4">
                    ...
                    <div className="flex items-center gap-3 px-2 mb-8 mt-2">
                        <div className="bg-accent-primary/10 flex items-center justify-center rounded-lg size-10 text-accent-primary">
                                ...
                                <div key={item.path}>
                                    {hasSubmenu ? (
                                        ...
                                        <Link
                                            ...
                                            ${isActive
                                                    ? 'bg-accent-primary/10 text-accent-primary border border-accent-primary/20 shadow-[0_0_10px_rgba(255,107,0,0.1)]'
                                                    : 'text-text-muted hover:text-white hover:bg-white/5'
                                                }
                                        `}
                                        >
