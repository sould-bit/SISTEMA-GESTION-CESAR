# SISALCHI – Documento de Requisitos, Arquitectura y Plan de Desarrollo

**Versión: 1.1 (Actualizado con Multi-Tenant)**  
**Autor:** Jhon (cliente) / Equipo de desarrollo  
**Resumen:** Este documento consolida todos los acuerdos, decisiones de arquitectura, requerimientos funcionales y no funcionales, y la hoja de ruta ordenada por prioridades para el desarrollo del sistema SISALCHI – Sistema Integral de Pedidos y Control Interno para Salchipapererías.

---

## 1. Información general del proyecto

**Nombre del sistema:** SISALCHI – Sistema Integral de Pedidos y Control Interno para Salchipapererías
...
```
admin.sisalchi.com              → Panel super-admin
elrincon.sisalchi.com           → Panel negocio "El Rincón"
cliente.elrincon.sisalchi.com   → PWA clientes
```
...
Dominio sisalchi.com                   $12 USD/año  (~4.000 COP/mes)
...
```bash
# Build backend
docker build -t sisalchi-backend ./backend
